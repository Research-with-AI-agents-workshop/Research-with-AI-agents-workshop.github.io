...
<template>
    <div>
        <!-- Google Group Banner -->
        <div
            class="bg-primary text-primary-content py-3 px-4 text-center text-sm"
        >
            <font-awesome-icon :icon="['fas', 'users']" class="mr-2" />
            We now have a Google Group! Join to receive announcements for
            upcoming sessions.
            <a
            ...
            <div class="hero-content text-center max-w-3xl">
                <div>
                    ...
                    <p class="mt-6 text-base opacity-80 max-w-2xl mx-auto">
                        Exploring how AI agents are transforming the research
                        process — from literature review and data analysis to
        ...
        <section class="max-w-3xl mx-auto px-4 py-12">
            ...
            <div class="mt-12">
                ...
                <p class="leading-relaxed">
                    The Research with AI Agents Workshop Series brings together
                    researchers to discuss how AI agents, from coding assistants
                    to autonomous research tools, are reshaping academic
                    workflows. Each session features a speaker sharing their
                    experiences, followed by open discussion.
                </p>
